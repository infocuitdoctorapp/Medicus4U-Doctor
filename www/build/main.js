...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__node_modules_rxjs__ = __webpack_require__(121);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__upcomingbookings_upcomingbookings__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__pastbookings_pastbookings__ = __webpack_require__(165);
...
var AppointmentPage = /** @class */ (function () {
    ...
    AppointmentPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-appointment',template:/*ion-inline-start:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\appointment\appointment.html"*/'<ion-content class="background-color">\n\n  <!-- <ion-refresher slot="fixed" (ionRefresh)="doRefresh($event)">\n\n    <ion-refresher-content pullingIcon="arrow-dropdown" pullingText="Pull to refresh" refreshingSpinner="circles" refreshingText="Refreshing...">\n\n    </ion-refresher-content>\n\n  </ion-refresher> -->\n\n  <ion-tabs class="relative" color="primary" tabsPlacement="top">\n\n    <ion-tab tabTitle="Upcoming Bookings" [root]="tab1root" [rootParams]="upcomingbooking"></ion-tab>\n\n    <ion-tab tabTitle="Past Bookings" [root]="tab2root" [rootParams]="pastbooking"></ion-tab>\n\n  </ion-tabs>\n\n</ion-content>'/*ion-inline-end:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\appointment\appointment.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__node_modules_rxjs__ = __webpack_require__(121);
...
var UpcomingbookingsPage = /** @class */ (function () {
    function UpcomingbookingsPage(navCtrl, navParams, alertCtrl, api, modalCtrl) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.alertCtrl = alertCtrl;
        this.api = api;
    ...
    UpcomingbookingsPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.subscription = __WEBPACK_IMPORTED_MODULE_4__node_modules_rxjs__["Observable"].interval(5000).subscribe(function (x) {
    ...
    UpcomingbookingsPage.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    UpcomingbookingsPage.prototype.navpatiententdetails = function (param) {
        var patientdetails = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_2__patientdetails_patientdetails__["a" /* PatientdetailsPage */], { "patientdetails": param });
    ...
    UpcomingbookingsPage.prototype.updateappointment = function (appointment) {
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                _this.api.updateappoinment('Cancel', appointment.app_id, data.value)
                    .subscribe(function (resp) {
        ...
        alert.addButton({
            ...
            handler: function (data) {
                ...
                appointment.flag = true;
                _this.api.updateappoinment('Checkout', appointment.app_id, data.value)
                    .subscribe(function (resp) {
                    if (resp.Message_Code == "RUS") {
...
var PastbookingsPage = /** @class */ (function () {
    function PastbookingsPage(navCtrl, navParams, modalCtrl, app) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.modalCtrl = modalCtrl;
        this.app = app;
    ...
    PastbookingsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-pastbookings',template:/*ion-inline-start:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\pastbookings\pastbookings.html"*/'<ion-content>\n\n    <ion-card *ngFor="let appointment of pastbooking" class="border-redius-15" (click)="navpatiententdetails(appointment)">\n\n        <ion-card-content>\n\n          <ion-row>\n\n            <ion-col col-3>\n\n            <ion-avatar item-left>\n\n              <img  class="borde-redus-100" [src]="appointment.image" style="height: 70px;">\n\n            </ion-avatar>\n\n          </ion-col>\n\n          <ion-col col-1></ion-col>\n\n          <ion-col col-6>\n\n            <p>User Name:<b>{{appointment.user_name}}</b></p>\n\n            <p>Token No:<b>{{appointment.token_no}}</b></p>\n\n            <p>Time:<b>{{appointment.token_time |date:"HH:mm a"}}</b></p>\n\n          </ion-col>\n\n          </ion-row>\n\n        </ion-card-content>\n\n      </ion-card>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\pastbookings\pastbookings.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* App */]])
    ], PastbookingsPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__appointment_appointment__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Providers_providerservice_providerservice__ = __webpack_require__(57);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ngx_webstorage__ = __webpack_require__(133);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_ngx_webstorage__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_appointment_appointment__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_patientdetails_patientdetails__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__pages_personal_personal__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_lifestyle_lifestyle__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_medical_medical__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_upcomingbookings_upcomingbookings__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_pastbookings_pastbookings__ = __webpack_require__(165);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_webstorage__ = __webpack_require__(133);
...
var ProviderserviceProvider = /** @class */ (function () {
    ...
    ProviderserviceProvider.prototype.updateappoinment = function (param, param1, param2) {
        var headers = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["a" /* Headers */]();
        headers.append('Content-Type', 'application/json');
        var options = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["d" /* RequestOptions */]({ headers: headers });
        var body = {
    ...
    ProviderserviceProvider = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_http__["b" /* Http */], __WEBPACK_IMPORTED_MODULE_3_ngx_webstorage__["b" /* SessionStorageService */]])
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"D:\Projects\Ionic\Medicus4U-Doctor\src\app\app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n\n'/*ion-inline-end:"D:\Projects\Ionic\Medicus4U-Doctor\src\app\app.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__personal_personal__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__lifestyle_lifestyle__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__medical_medical__ = __webpack_require__(164);
...
var PatientdetailsPage = /** @class */ (function () {
    ...
    PatientdetailsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-patientdetails',template:/*ion-inline-start:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\patientdetails\patientdetails.html"*/'<ion-header>\n\n  <ion-navbar color="primary">\n\n    <ion-row>\n\n        <ion-col col-11>\n\n            <ion-title>Patient Details</ion-title>\n\n        </ion-col>\n\n        <ion-col col-1>\n\n            <ion-icon name="close" style="color:white" (click)="closeModal()"></ion-icon>\n\n        </ion-col>\n\n    </ion-row>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content class="card-background-page">\n\n  <ion-card>\n\n    <img src="../../assets/imgs/background/background-4.jpg" />\n\n    <div class="card-title">\n\n      {{patientdetailsarr.user_name}}\n\n    </div>\n\n    <div class="card-subtitle">\n\n      {{patientdetailsarr.mobile}}\n\n    </div>\n\n  </ion-card>\n\n  <ion-tabs class="relative" color="primary" tabsPlacement="top">\n\n    <ion-tab tabTitle="Personal" [root]="tab1root" [rootParams]="patientdetailss"></ion-tab>\n\n    <ion-tab tabTitle="Medical" [root]="tab2root" [rootParams]="patientdetailss"></ion-tab>\n\n    <ion-tab tabTitle="Lifestyle" [root]="tab3root" [rootParams]="patientdetailss"></ion-tab>\n\n  </ion-tabs>\n\n</ion-content>'/*ion-inline-end:"D:\Projects\Ionic\Medicus4U-Doctor\src\pages\patientdetails\patientdetails.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */], __WEBPACK_IMPORTED_MODULE_5__Providers_providerservice_providerservice__["a" /* ProviderserviceProvider */]])
    ], PatientdetailsPage);
